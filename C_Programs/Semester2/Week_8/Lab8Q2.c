...
Programs Description: This program demonstrates using nested structures to 
    ...
    (d) modifies only DOB, first and surname of person2
    (e) displays the second person's new data
...
int main() {
    ...
    // modifies some of the details of person2
    strcpy(person2.firstname, "Vivian");
    strcpy(person2.surname, "Ugochukwu");
    person2.DOB.day = 20;
    person2.DOB.month = 11;
    person2.DOB.year = 2008;
