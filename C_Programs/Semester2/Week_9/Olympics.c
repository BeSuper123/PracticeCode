...
This program uses calloc() to dynamically allocate a block of memory, enter data into the memory block, and check for
specific details for a set of athletes (number entered by the user) competing in the 100m sprint in the Summer Olympic Games. 
